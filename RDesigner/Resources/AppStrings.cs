...
public static class AppStrings
{
    ...
    public static string InstallerLinuxPostgresReinstallScanLog = "Поиск предыдущего экземпляра PostgreSQL с базой OilCtrl перед переустановкой АРМ.";
    public static string InstallerLinuxPostgresConfiguredPortLog = "В конфигурации установленного АРМ указан порт PostgreSQL: {Port}";
    public static string InstallerLinuxPostgresClusterToolsNotFoundLog = "Команда pg_lsclusters не найдена. Проверка предыдущих кластеров PostgreSQL пропущена.";
    public static string InstallerLinuxPostgresNoClustersLog = "Кластеры PostgreSQL в системе не найдены.";
    public static string InstallerLinuxPostgresCheckingClusterLog = "Проверяется кластер PostgreSQL {Cluster} на порту {Port}.";
    public static string InstallerLinuxPostgresStartingClusterForBackupLog = "Кластер PostgreSQL {Cluster} остановлен. Выполняется запуск для резервного копирования.";
    public static string InstallerLinuxPostgresClusterCheckFailedLog = "Не удалось проверить базы в кластере PostgreSQL {Cluster}: {Reason}";
    public static string InstallerLinuxPostgresOilCtrlFoundLog = "База OilCtrl найдена в кластере PostgreSQL {Cluster} на порту {Port}.";
    public static string InstallerLinuxPostgresPgDumpNotFoundLog = "Не найден pg_dump для резервного копирования базы OilCtrl.";
    public static string InstallerLinuxPostgresBackupCompletedLog = "Резервная копия базы OilCtrl создана: {Path}";
    public static string InstallerLinuxPostgresBackupFailedContinuingLog = "Не удалось создать резервную копию базы OilCtrl: {Reason}. Переустановка будет продолжена.";
    public static string InstallerLinuxPostgresRemovingClusterLog = "Удаление предыдущего кластера PostgreSQL: {Cluster}";
    public static string InstallerLinuxPostgresClusterRemovedLog = "Предыдущий кластер PostgreSQL {Cluster} удален.";
    public static string InstallerLinuxPostgresClusterRemoveFailedLog = "Не удалось удалить предыдущий кластер PostgreSQL {Cluster}.";
    public static string InstallerLinuxPostgresOilCtrlNotFoundLog = "Предыдущий кластер PostgreSQL с базой OilCtrl не найден. Установка будет продолжена.";
